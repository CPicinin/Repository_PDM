<%@ Page Title="" Language="C#" MasterPageFile="~/PDM.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ConsultaTerceiro.aspx.cs" Inherits="PDM.View.ConsultaTerceiro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>PDM - Consulta de Terceiros</title>
</asp:Content>
                ...
                <div class="box-header">
                  <div class="box-tools">
                    <div class="input-group" style="width: 150px;">
                        <a class="btn btn-block btn-primary pull-right" href="CadastraTerceiro.aspx">Novo</a>
                    </div>
                  </div>
                </div><!-- /.box-header -->
            </div>
